	...
	:Textured3DObject(texMgr)
{
	...
	m_pObjectManager->add_gui_controller("Birds", m_pObjectManager->generate_checkbox("Focus on Bird", &m_bCamFocused));
	...
	m_pObjectManager->add_gui_controller("Birds", m_pObjectManager->generate_slider("Zoom on Bird", 100.0f, 1000.0f, 1.0f, get_zoom()));
